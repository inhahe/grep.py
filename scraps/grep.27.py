...
#fix some things use concatenation and some things use f strins, make them all use f strings
...
if os.name=="nt":
  try:
    ...
    print()
if colors:
  black, darkred, darkgreen, darkyellow, darkblue, darkpurple, darkcyan, lightgray = (f"\033[{x}m" for x in range(30, 38))
  gray, red, green, yellow, blue, purple, cyan, white = (f"\033[1;{x}m" for x in range(30, 38))
else:
