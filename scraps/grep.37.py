...
#option to set colors back to the defaults
...
#--x_files * gives "permission denied:" with no file name
#is_subpath doesn't work.
#filter out terminal escape sequences (are they all below 32?) in match text
