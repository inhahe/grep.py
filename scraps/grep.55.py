...
#check if gnu grep has -p, -f, --x-files, -c or --x-paths and use the same names. doesn't have my -c option.
...
parser.add_argument("-f", "--include-files", nargs="*", help="search files matching these filename patterns. this option exists so you can search files even if you don't specify a regex")
...
parser.add_argument("-p", "--include-paths", nargs="*", metavar="path", help="search these paths")
parser.add_argument("--x-files", nargs="*", metavar = "filespec", help="exclude these filename patterns from search")
parser.add_argument("--x-paths", nargs="*", metavar = "path", help="exclude these paths from search")
parser.add_argument("-i", "--ignore-case", action="store_true", help="make search case-insensitive")
