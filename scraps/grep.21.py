...
#add handling for invalid regex
...
if colors:
  e = "\033["
  black, darkred, darkgreen, darkyellow, darkblue, darkpurple, darkcyan, lightgray = (e+str(x)+"m" for x in range(30, 38))
  gray, red, green, yellow, blue, purple, cyan, white = (e+"1;"+str(x)+"m" for x in range(30, 38))
else:
  black, darkred, darkgreen, darkyellow, darkblue, darkpurple, darkcyan, lightgray = [""]*8
  darkgray, red, green, yellow, blue, purple, cyan, white = [""]*8
...
def ld(directory=None):
  try:
    ...
    print(f"{red}could not open: {e.msg}: {white}{directory}")
    return []
  else:
    return r
