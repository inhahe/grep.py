...
#neither is_subpath works on \$RECYCLE.BIN
#`grep.py e -r -p d:\temp4 --x_paths temp5` doesn't exclude temp5.
#it does exclude relative directories.
#`grep.py e -r -p d:\temp4 --x_paths \temp5` doesn't work either.
