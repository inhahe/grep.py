...
if args.set_colors:
  ...
  fncolor, coloncolor, lncolor, matchcolor, errcolor = (colors.get(x) for x in args.set_colors)
else:
  if os.path.isfile(cf):
    fncolor, coloncolor, lncolor, matchcolor, errcolor = (colors.get(x) for x in open(cf).read().split())
  else:
